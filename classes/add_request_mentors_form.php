 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_recommend_add_request_mentors_form extends moodleform {
    /**
     * Form definition
     */
    public function definition() {
        ...
        $mentortable = $this->_customdata['mentortable'];

        $mform = $this->_form;

        $canadd = $manager->can_add_request();

        $mform->addElement('hidden', 'action', 'requestmentor');
        ...
        $mform->addElement('html', $mentortable);
